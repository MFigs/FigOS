...
(function (TSOS) {
    var ProgramCommand = (function () {
        ...
        ProgramCommand.prototype.translateAddressFromHexString = function (inputString) {
            var decimalValue = 0;
        ...
        ProgramCommand.prototype.executeCommand = function () {
            switch (this.command) {
                ...
                case "6D": {
                    // TODO: HANDLE CARRY
                    // Add with carry from address to accumulator
                    var addValue = this.translateFromHexString(_Kernel.memManager.accessMem(this.translateAddressFromHexString(this.arg2 + this.arg1)));

module TSOS {
    ...
    export class DeviceDriverHDD extends DeviceDriver {
        ...
        public readFile(fileName: string, access: string) {
            ...
            for(var s = 0; s < 8; s++) {
                ...
                for(var b = 0; b < 8; b++) {
                    ...
                    if (hddBlock.charAt(0) === '1') {
                        ...
                        var ch: string = hddBlock.charAt(0);
                        var tempFile: string = "";
                        while (ch !== "*") {
            ...
            var ch1: string = blockDataFinal.charAt(0);
            var tempFile1: string = "";
            while (ch1 !== "~") {
        ...
        public createFile(fileName:string, access: string) {
        ...
        public writeFile(fileName: string, dataString: string, access: string) {
